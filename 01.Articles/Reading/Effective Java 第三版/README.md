...
TABLE 
  ...
  join(filter(file.tags, (x) => x != "#Resource" and x != "#Java/EffectiveJava"), " ") AS "🏷️ 标签", 
  rate AS "⭐ 评分", 
  date AS "📅 日期"
FROM #Resource AND #Java/EffectiveJava 
